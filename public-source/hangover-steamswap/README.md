# Hangover 11.9 Steam client swap

This patch ports Proton Wine's steamclient export swap to Hangover 11.9 and
...
`2e8ad15d5b7b87ef0e1520bf9fec2ecfb31fd1b1`, configure the normal Termux
...
only on top of `hangover-wine (= 11.9)`.
